...
export default function ProcessCards({ number, title, item1, item2, item3 }) {
  return (
    <div className="proces-card rounded-xl border w-full max-w-full sm:max-w-sm md:max-w-md lg:max-w-lg bg-black/50">
      <div className="flex flex-col p-4 sm:p-6 md:p-8 gap-3 sm:gap-4 md:gap-6">
        {/* Step Number */}
        <p className="text-basegreen text-lg sm:text-xl md:text-2xl font-semibold">
          {number}
        </p>
