...
export default function ProcessCards({ software }) {
  ...
  return (
    <div
      ...
      className="group relative overflow-hidden font-parkinsans work-card rounded-xl border cursor-pointer w-full max-w-[300px] sm:max-w-[340px] md:max-w-[400px] bg-black/50 mx-auto"
    >
      {/* Hover Overlay */}
      ...
      {/* Content */}
      <div className="relative flex flex-col justify-center text-center h-full p-6 sm:p-8">
